...
"""
Seat allocation utilities for automatic seat reservation
...
def get_available_seats(flight, seat_class='economy', count=1):
    ...
    Returns:
        List of available Seat instances
    """
    try:
        # Get all available seats for the flight and class
...
def reserve_seats_for_saga(correlation_id, flight_id, passenger_count, seat_class='economy', user_id=None):
    ...
    Args:
        correlation_id: SAGA correlation ID
        flight_id: Flight ID
    ...
    try:
        ...
        # Check if reservation already exists for this correlation_id
