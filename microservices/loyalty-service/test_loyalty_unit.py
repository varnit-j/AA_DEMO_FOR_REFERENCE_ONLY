...
class LoyaltyServiceUnitTests(unittest.TestCase):
    ...
    def test_service_health(self):
        ...
        print(f"✅ Loyalty Service Health: Status {response.status_code}")
