...
if SAGA_AVAILABLE:
    urlpatterns += [
        ...
        path('saga/reserve-seat/', saga_final_steps.reserve_seat, name='saga_reserve_seat'),
        path('saga/confirm-booking/', saga_final_steps.confirm_booking, name='saga_confirm_booking'),
